...
- Update compose BOM to 2025.10.00
- Update wear-compose to 1.5.3
- Update room to 2.8.2
- Update camera to 1.5.1

### Shared

- Update firebase BOM to 34.4.0
- Update google-gms-plugin to 4.4.4
- Update ksp to 2.2.20-2.0.4
- Update okhttp to 5.2.1
- Update koin-annotations to 2.2.0

## 2025.10.03

### AndroidX

- Update window to 1.5.0
- Update wear-compose to 1.5.2
- Update work to 2.10.5
- Update sqlite to 2.6.1
- Update room to 2.8.1
- Update compose BOM to 2025.09.01
- Update navigation safeargs to 2.9.5
- Update savedstate to 1.3.3
- Update lifecycle to 2.9.4

### Shared

- Update kradle to 2.0.5
- Update android-cachefix-plugin to 3.0.2
- Update mockk to 1.14.6
- Update mockito-kotlin to 6.1.0
- Update junit to 6.0.0
- Update hilt to 2.57.2
- Update mockito to 5.20.0
- Update firebase BOM to 34.3.0
- Update landscapist to 2.6.1
- Update lottie to 6.6.10
- Update jetbrains-compose to 1.9.0
- Update glide to 5.0.5

## 2025.09.12

### AndroidX

- Update wear-input to 1.2.0
- Update emoji2 to 1.6.0
- Update hilt to 1.3.0
- Update wear-compoes to 1.5.1
- Update room to 2.8.0
- Update compose BOM to 2025.09.00
- Update wear-ongoing to 1.1.0
- Update camera to 1.5.0
- Update activity to 1.11.0
- Update work to 2.10.4
- Update navigation to 2.9.4
- Update benchmark to 1.4.1

### Shared

- Update protobuf to 4.32.1
- Update gson to 2.13.2
- Update ksp to 2.2.20-2.0.3
- Update truth to 1.4.5
...
- Remove hilt KAPT plugin and replace with a single KSP version
...
- Fix issue in compose plugin that excludes everything from the META-INF directory
